...
4. **Команда запуска (уже настроена!):**
   - ✅ Railway автоматически использует `npm start` из `package.json`
   - ✅ В `package.json` уже настроено: `"start": "USE_WEBHOOK=true node dist/bot/webhook-server.js"`
